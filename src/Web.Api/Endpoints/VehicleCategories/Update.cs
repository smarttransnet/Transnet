...
internal sealed class Update : IEndpoint
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        ...
        {
            var command = new UpdateVehicleCategoryCommand(id, request.Name, request.Description);
...
public sealed record UpdateVehicleCategoryRequest(string Name, string? Description);
